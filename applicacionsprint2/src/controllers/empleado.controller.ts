...
import {NotificacionesRobertService} from '../services';

export class EmpleadoController {
  constructor(
    @repository(EmpleadoRepository)
    public empleadoRepository : EmpleadoRepository,
    @service (NotificacionesRobertService)
    public NotificionesRobertService:NotificacionesRobertService,
  ) {}
  ...
  async create(
    ...
    this.NotificionesRobertService.EnviarSMS();
